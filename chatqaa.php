...
<head>
    ...
    <title>Insurance Q&A Chatbot</title>
    <style type="text/css">
        .header_one{
            width:600px;
            height:15px;
...
<body onload="FocusOnBottom()">
	...
	<h1 class="header_one">Chatbot Prototype: Insurance Q&A</h1>
	<p class="intro"><i>This is a prototype chatbot built in the research project sponsored by Fundacion MAPFRE.
	The chatbot is capable of answering general insurance questions.</i></p>
